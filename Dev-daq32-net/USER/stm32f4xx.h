...
typedef int8_t    INT8;      /**<  8bit integer type */
typedef int16_t   INT16;     /**< 16bit integer type */
typedef int32_t    INT32;     /**< 32bit integer type */
typedef uint8_t     INT8U;     /**<  8bit unsigned integer type */
typedef uint16_t    INT16U;    /**< 16bit unsigned integer type */
typedef uint32_t    INT32U;    /**< 32bit unsigned integer type */
